 ...
 * server, such as "Unknown Avatar" or "Unknown Message Type."
 *
 */
...
/*
 *
 * Gets the positions of all of the avatars on the maze in a position array, 
 ...
 * finding each other, or because the movelimit or timelimit was reached, or 
